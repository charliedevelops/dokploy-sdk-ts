...
export type MysqlUpdateSecurity = {
...
/** @internal */
export const MysqlUpdateSecurity$inboundSchema: z.ZodType<
  MysqlUpdateSecurity,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type MysqlUpdateSecurity$Outbound = {
  Authorization: string;
};

/** @internal */
export const MysqlUpdateSecurity$outboundSchema: z.ZodType<
  MysqlUpdateSecurity$Outbound,
  z.ZodTypeDef,
  MysqlUpdateSecurity
> = z.object({
  authorization: z.string(),
 ...
 */
export namespace MysqlUpdateSecurity$ {
  /** @deprecated use `MysqlUpdateSecurity$inboundSchema` instead. */
  export const inboundSchema = MysqlUpdateSecurity$inboundSchema;
  /** @deprecated use `MysqlUpdateSecurity$outboundSchema` instead. */
  export const outboundSchema = MysqlUpdateSecurity$outboundSchema;
  /** @deprecated use `MysqlUpdateSecurity$Outbound` instead. */
  export type Outbound = MysqlUpdateSecurity$Outbound;
}

export function mysqlUpdateSecurityToJSON(
  mysqlUpdateSecurity: MysqlUpdateSecurity,
): string {
  return JSON.stringify(
    MysqlUpdateSecurity$outboundSchema.parse(mysqlUpdateSecurity),
  );
}

export function mysqlUpdateSecurityFromJSON(
  jsonString: string,
): SafeParseResult<MysqlUpdateSecurity, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MysqlUpdateSecurity$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MysqlUpdateSecurity' from JSON`,
  );
}
