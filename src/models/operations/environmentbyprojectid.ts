...
export type EnvironmentByProjectIdSecurity = {
...
/** @internal */
export const EnvironmentByProjectIdSecurity$inboundSchema: z.ZodType<
  EnvironmentByProjectIdSecurity,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type EnvironmentByProjectIdSecurity$Outbound = {
  Authorization: string;
};

/** @internal */
export const EnvironmentByProjectIdSecurity$outboundSchema: z.ZodType<
  EnvironmentByProjectIdSecurity$Outbound,
  z.ZodTypeDef,
  EnvironmentByProjectIdSecurity
> = z.object({
  authorization: z.string(),
 ...
 */
export namespace EnvironmentByProjectIdSecurity$ {
  /** @deprecated use `EnvironmentByProjectIdSecurity$inboundSchema` instead. */
  export const inboundSchema = EnvironmentByProjectIdSecurity$inboundSchema;
  /** @deprecated use `EnvironmentByProjectIdSecurity$outboundSchema` instead. */
  export const outboundSchema = EnvironmentByProjectIdSecurity$outboundSchema;
  /** @deprecated use `EnvironmentByProjectIdSecurity$Outbound` instead. */
  export type Outbound = EnvironmentByProjectIdSecurity$Outbound;
}

export function environmentByProjectIdSecurityToJSON(
  environmentByProjectIdSecurity: EnvironmentByProjectIdSecurity,
): string {
  return JSON.stringify(
    EnvironmentByProjectIdSecurity$outboundSchema.parse(
      environmentByProjectIdSecurity,
    ),
  );
}

export function environmentByProjectIdSecurityFromJSON(
  jsonString: string,
): SafeParseResult<EnvironmentByProjectIdSecurity, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => EnvironmentByProjectIdSecurity$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'EnvironmentByProjectIdSecurity' from JSON`,
  );
}
