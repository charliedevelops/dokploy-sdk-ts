...
export type MongoDeploySecurity = {
...
/** @internal */
export const MongoDeploySecurity$inboundSchema: z.ZodType<
  MongoDeploySecurity,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export type MongoDeploySecurity$Outbound = {
  Authorization: string;
};

/** @internal */
export const MongoDeploySecurity$outboundSchema: z.ZodType<
  MongoDeploySecurity$Outbound,
  z.ZodTypeDef,
  MongoDeploySecurity
> = z.object({
  authorization: z.string(),
 ...
 */
export namespace MongoDeploySecurity$ {
  /** @deprecated use `MongoDeploySecurity$inboundSchema` instead. */
  export const inboundSchema = MongoDeploySecurity$inboundSchema;
  /** @deprecated use `MongoDeploySecurity$outboundSchema` instead. */
  export const outboundSchema = MongoDeploySecurity$outboundSchema;
  /** @deprecated use `MongoDeploySecurity$Outbound` instead. */
  export type Outbound = MongoDeploySecurity$Outbound;
}

export function mongoDeploySecurityToJSON(
  mongoDeploySecurity: MongoDeploySecurity,
): string {
  return JSON.stringify(
    MongoDeploySecurity$outboundSchema.parse(mongoDeploySecurity),
  );
}

export function mongoDeploySecurityFromJSON(
  jsonString: string,
): SafeParseResult<MongoDeploySecurity, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => MongoDeploySecurity$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'MongoDeploySecurity' from JSON`,
  );
}
