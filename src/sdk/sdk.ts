...
import { GitProviders } from "./gitproviders.js";
...
export class Dokploy extends ClientSDK {
  ...
  private _gitProviders?: GitProviders;
  get gitProviders(): GitProviders {
    return (this._gitProviders ??= new GitProviders(this._options));
  }
