...
async function run() {
  const result = await dokploy.applications.move({
    applicationId: "<id>",
...
import { applicationsMove } from "dokploy-sdk/funcs/applicationsMove.js";
...
async function run() {
  const res = await applicationsMove(dokploy, {
    applicationId: "<id>",
    targetEnvironmentId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("applicationsMove failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.applications.readTraefikConfig({
    applicationId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { applicationsReadTraefikConfig } from "dokploy-sdk/funcs/applicationsReadTraefikConfig.js";
...
async function run() {
  const res = await applicationsReadTraefikConfig(dokploy, {
    applicationId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("applicationsReadTraefikConfig failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.applications.refreshToken({
    applicationId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { applicationsRefreshToken } from "dokploy-sdk/funcs/applicationsRefreshToken.js";
...
async function run() {
  const res = await applicationsRefreshToken(dokploy, {
    applicationId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("applicationsRefreshToken failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.applications.saveGithubProvider({
    applicationId: "<id>",
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { applicationsSaveGithubProvider } from "dokploy-sdk/funcs/applicationsSaveGithubProvider.js";
...
async function run() {
  const res = await applicationsSaveGithubProvider(dokploy, {
    applicationId: "<id>",
    enableSubmodules: true,
    githubId: "<id>",
    owner: null,
  ...
  if (res.ok) {
    ...
    console.log("applicationsSaveGithubProvider failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.applications.start({
    applicationId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { applicationsStart } from "dokploy-sdk/funcs/applicationsStart.js";
...
async function run() {
  const res = await applicationsStart(dokploy, {
    applicationId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("applicationsStart failed:", res.error);
  }
}
