...
* [create](#create)
* [listFiles](#listfiles)
* [manualBackupCompose](#manualbackupcompose)
...
* [manualBackupWebServer](#manualbackupwebserver)
* [one](#one)
* [remove](#remove)
* [update](#update)
...
import { backupCreate } from "dokploy-sdk/funcs/backupCreate.js";
...
async function run() {
  const result = await dokploy.backup.listFiles({
    destinationId: "<id>",
    search: "<value>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupListFiles } from "dokploy-sdk/funcs/backupListFiles.js";
...
async function run() {
  const res = await backupListFiles(dokploy, {
    destinationId: "<id>",
    search: "<value>",
  });
  if (res.ok) {
    ...
    console.log("backupListFiles failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.backup.manualBackupCompose({
    backupId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupManualBackupCompose } from "dokploy-sdk/funcs/backupManualBackupCompose.js";
...
async function run() {
  const res = await backupManualBackupCompose(dokploy, {
    backupId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("backupManualBackupCompose failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupManualBackupMariadb } from "dokploy-sdk/funcs/backupManualBackupMariadb.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupManualBackupMongo } from "dokploy-sdk/funcs/backupManualBackupMongo.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupManualBackupMySql } from "dokploy-sdk/funcs/backupManualBackupMySql.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupManualBackupPostgres } from "dokploy-sdk/funcs/backupManualBackupPostgres.js";
...
async function run() {
  const result = await dokploy.backup.manualBackupWebServer({
    backupId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupManualBackupWebServer } from "dokploy-sdk/funcs/backupManualBackupWebServer.js";
...
async function run() {
  const res = await backupManualBackupWebServer(dokploy, {
    backupId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("backupManualBackupWebServer failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.backup.one({
    backupId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupOne } from "dokploy-sdk/funcs/backupOne.js";
...
async function run() {
  const res = await backupOne(dokploy, {
    backupId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("backupOne failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupRemove } from "dokploy-sdk/funcs/backupRemove.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { backupUpdate } from "dokploy-sdk/funcs/backupUpdate.js";
