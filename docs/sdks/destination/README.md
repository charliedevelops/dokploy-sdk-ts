...
async function run() {
  const result = await dokploy.destination.getAll();
...
import { destinationGetAll } from "dokploy-sdk/funcs/destinationGetAll.js";
...
async function run() {
  const res = await destinationGetAll(dokploy);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("destinationGetAll failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { destinationCreate } from "dokploy-sdk/funcs/destinationCreate.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { destinationGet } from "dokploy-sdk/funcs/destinationGet.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { destinationRemove } from "dokploy-sdk/funcs/destinationRemove.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { destinationTestConnection } from "dokploy-sdk/funcs/destinationTestConnection.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { destinationUpdate } from "dokploy-sdk/funcs/destinationUpdate.js";
