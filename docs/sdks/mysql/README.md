...
import { mysqlChangeStatus } from "dokploy-sdk/funcs/mysqlChangeStatus.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlCreate } from "dokploy-sdk/funcs/mysqlCreate.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlDeploy } from "dokploy-sdk/funcs/mysqlDeploy.js";
...
async function run() {
  const result = await dokploy.mysql.move({
    mysqlId: "<id>",
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlMove } from "dokploy-sdk/funcs/mysqlMove.js";
...
async function run() {
  const res = await mysqlMove(dokploy, {
    mysqlId: "<id>",
    targetEnvironmentId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("mysqlMove failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlGet } from "dokploy-sdk/funcs/mysqlGet.js";
...
async function run() {
  const result = await dokploy.mysql.rebuild({
    mysqlId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlRebuild } from "dokploy-sdk/funcs/mysqlRebuild.js";
...
async function run() {
  const res = await mysqlRebuild(dokploy, {
    mysqlId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("mysqlRebuild failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlReload } from "dokploy-sdk/funcs/mysqlReload.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlRemove } from "dokploy-sdk/funcs/mysqlRemove.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlSaveEnvironment } from "dokploy-sdk/funcs/mysqlSaveEnvironment.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlSaveExternalPort } from "dokploy-sdk/funcs/mysqlSaveExternalPort.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlStart } from "dokploy-sdk/funcs/mysqlStart.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlStop } from "dokploy-sdk/funcs/mysqlStop.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mysqlUpdate } from "dokploy-sdk/funcs/mysqlUpdate.js";
