...
import { redirectsCreate } from "dokploy-sdk/funcs/redirectsCreate.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { redirectsDelete } from "dokploy-sdk/funcs/redirectsDelete.js";
...
async function run() {
  const result = await dokploy.redirects.get({
    redirectId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { redirectsGet } from "dokploy-sdk/funcs/redirectsGet.js";
...
async function run() {
  const res = await redirectsGet(dokploy, {
    redirectId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("redirectsGet failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { redirectsUpdate } from "dokploy-sdk/funcs/redirectsUpdate.js";
