...
import { redirectsRedirectsCreate } from "dokploy-sdk/funcs/redirectsRedirectsCreate.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("redirectsRedirectsCreate failed:", res.error);
  }
}
...
| `security`                                                                                                                                                                     | [operations.RedirectsCreateSecurity](../../models/operations/redirectscreatesecurity.md)                                                                                       | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
...
async function run() {
  const result = await dokploy.redirects.redirectsDelete({
    authorization: process.env["DOKPLOY_AUTHORIZATION"] ?? "",
  }, {
    redirectId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { redirectsRedirectsDelete } from "dokploy-sdk/funcs/redirectsRedirectsDelete.js";
...
async function run() {
  const res = await redirectsRedirectsDelete(dokploy, {
    authorization: process.env["DOKPLOY_AUTHORIZATION"] ?? "",
  }, {
    redirectId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("redirectsRedirectsDelete failed:", res.error);
  }
}
...
| `security`                                                                                                                                                                     | [operations.RedirectsDeleteSecurity](../../models/operations/redirectsdeletesecurity.md)                                                                                       | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.RedirectsDeleteResponse](../../models/operations/redirectsdeleteresponse.md)\>**
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { redirectsRedirectsUpdate } from "dokploy-sdk/funcs/redirectsRedirectsUpdate.js";
...
async function run() {
  ...
  if (res.ok) {
    ...
    console.log("redirectsRedirectsUpdate failed:", res.error);
  }
}
...
| `security`                                                                                                                                                                     | [operations.RedirectsUpdateSecurity](../../models/operations/redirectsupdatesecurity.md)                                                                                       | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
**Promise\<[operations.RedirectsUpdateResponse](../../models/operations/redirectsupdateresponse.md)\>**
