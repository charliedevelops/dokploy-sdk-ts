...
import { mongoChangeStatus } from "dokploy-sdk/funcs/mongoChangeStatus.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoCreate } from "dokploy-sdk/funcs/mongoCreate.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoDeploy } from "dokploy-sdk/funcs/mongoDeploy.js";
...
async function run() {
  const result = await dokploy.mongo.move({
    mongoId: "<id>",
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoMove } from "dokploy-sdk/funcs/mongoMove.js";
...
async function run() {
  const res = await mongoMove(dokploy, {
    mongoId: "<id>",
    targetEnvironmentId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("mongoMove failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.mongo.getOne({
    mongoId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoGetOne } from "dokploy-sdk/funcs/mongoGetOne.js";
...
async function run() {
  const res = await mongoGetOne(dokploy, {
    mongoId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("mongoGetOne failed:", res.error);
  }
}
...
async function run() {
  const result = await dokploy.mongo.rebuild({
    mongoId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoRebuild } from "dokploy-sdk/funcs/mongoRebuild.js";
...
async function run() {
  const res = await mongoRebuild(dokploy, {
    mongoId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("mongoRebuild failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoReload } from "dokploy-sdk/funcs/mongoReload.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoRemove } from "dokploy-sdk/funcs/mongoRemove.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoSaveEnvironment } from "dokploy-sdk/funcs/mongoSaveEnvironment.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoSaveExternalPort } from "dokploy-sdk/funcs/mongoSaveExternalPort.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoStart } from "dokploy-sdk/funcs/mongoStart.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoStop } from "dokploy-sdk/funcs/mongoStop.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mongoUpdate } from "dokploy-sdk/funcs/mongoUpdate.js";
