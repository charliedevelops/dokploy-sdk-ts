...
import { mariadbChangeStatus } from "dokploy-sdk/funcs/mariadbChangeStatus.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbCreate } from "dokploy-sdk/funcs/mariadbCreate.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbDeploy } from "dokploy-sdk/funcs/mariadbDeploy.js";
...
async function run() {
  const result = await dokploy.mariadb.move({
    mariadbId: "<id>",
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbMove } from "dokploy-sdk/funcs/mariadbMove.js";
...
async function run() {
  const res = await mariadbMove(dokploy, {
    mariadbId: "<id>",
    targetEnvironmentId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("mariadbMove failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbGet } from "dokploy-sdk/funcs/mariadbGet.js";
...
async function run() {
  const result = await dokploy.mariadb.rebuild({
    mariadbId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbRebuild } from "dokploy-sdk/funcs/mariadbRebuild.js";
...
async function run() {
  const res = await mariadbRebuild(dokploy, {
    mariadbId: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("mariadbRebuild failed:", res.error);
  }
}
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbReload } from "dokploy-sdk/funcs/mariadbReload.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbRemove } from "dokploy-sdk/funcs/mariadbRemove.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbSaveEnvironment } from "dokploy-sdk/funcs/mariadbSaveEnvironment.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbSaveExternalPort } from "dokploy-sdk/funcs/mariadbSaveExternalPort.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbStart } from "dokploy-sdk/funcs/mariadbStart.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbStop } from "dokploy-sdk/funcs/mariadbStop.js";
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { mariadbUpdate } from "dokploy-sdk/funcs/mariadbUpdate.js";
