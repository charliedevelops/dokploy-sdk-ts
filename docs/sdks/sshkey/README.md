...
async function run() {
  const result = await dokploy.sshKey.sshKeyCreate({
    authorization: process.env["DOKPLOY_AUTHORIZATION"] ?? "",
  }, {
    name: "<value>",
    organizationId: "<id>",
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { sshKeySshKeyCreate } from "dokploy-sdk/funcs/sshKeySshKeyCreate.js";
...
async function run() {
  const res = await sshKeySshKeyCreate(dokploy, {
    authorization: process.env["DOKPLOY_AUTHORIZATION"] ?? "",
  }, {
    name: "<value>",
    organizationId: "<id>",
  ...
  if (res.ok) {
    ...
    console.log("sshKeySshKeyCreate failed:", res.error);
  }
}
...
| `security`                                                                                                                                                                     | [operations.SshKeyCreateSecurity](../../models/operations/sshkeycreatesecurity.md)                                                                                             | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await dokploy.sshKey.sshKeyOne({
    authorization: process.env["DOKPLOY_AUTHORIZATION"] ?? "",
  }, {
    sshKeyId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { sshKeySshKeyOne } from "dokploy-sdk/funcs/sshKeySshKeyOne.js";
...
async function run() {
  const res = await sshKeySshKeyOne(dokploy, {
    authorization: process.env["DOKPLOY_AUTHORIZATION"] ?? "",
  }, {
    sshKeyId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("sshKeySshKeyOne failed:", res.error);
  }
}
...
| `security`                                                                                                                                                                     | [operations.SshKeyOneSecurity](../../models/operations/sshkeyonesecurity.md)                                                                                                   | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
async function run() {
  const result = await dokploy.sshKey.sshKeyUpdate({
    authorization: process.env["DOKPLOY_AUTHORIZATION"] ?? "",
  }, {
    sshKeyId: "<id>",
  });
...
```typescript
import { DokployCore } from "dokploy-sdk/core.js";
import { sshKeySshKeyUpdate } from "dokploy-sdk/funcs/sshKeySshKeyUpdate.js";
...
async function run() {
  const res = await sshKeySshKeyUpdate(dokploy, {
    authorization: process.env["DOKPLOY_AUTHORIZATION"] ?? "",
  }, {
    sshKeyId: "<id>",
  });
  if (res.ok) {
    ...
    console.log("sshKeySshKeyUpdate failed:", res.error);
  }
}
...
| `security`                                                                                                                                                                     | [operations.SshKeyUpdateSecurity](../../models/operations/sshkeyupdatesecurity.md)                                                                                             | :heavy_check_mark:                                                                                                                                                             | The security requirements to use for the request.                                                                                                                              |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
