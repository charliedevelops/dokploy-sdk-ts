...
**Promise\<[operations.ProjectAllResponse](../../models/operations/projectallresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="project-duplicate" method="post" path="/project.duplicate" -->
```typescript
import { Dokploy } from "dokploy-sdk";
